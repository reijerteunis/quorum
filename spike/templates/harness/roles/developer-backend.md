---
adapter: codex
paths: [spike, harness, docs, backlog, contracts]
---
...
your allowed paths: spike, harness, docs, backlog, contracts. When a contract is wrong, you stop and report it rather
