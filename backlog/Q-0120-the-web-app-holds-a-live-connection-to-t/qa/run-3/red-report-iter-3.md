...
[32m@quorum/shared:test: [0mcache bypass, force executing [2m7a122580b42fea6b[0m
[35m@quorum/templates:test: [0mcache bypass, force executing [2m707dee140f887bc9[0m
[36m@quorum/compiler:test: [0mcache bypass, force executing [2m139b1473c7d9fe18[0m
...
[35m@quorum/templates:test: [0m[2m   Start at [22m 00:25:32
[36m@quorum/compiler:test: [0m[2m Test Files [22m [1m[32m1 passed[39m[22m[90m (1)[39m
[35m@quorum/templates:test: [0m[2m   Duration [22m 137ms[2m (transform 12ms, setup 0ms, import 18ms, tests 1ms, environment 0ms)[22m
[36m@quorum/compiler:test: [0m[2m      Tests [22m [1m[32m1 passed[39m[22m[90m (1)[39m
[36m@quorum/compiler:test: [0m[2m   Start at [22m 00:25:32
[36m@quorum/compiler:test: [0m[2m   Duration [22m 137ms[2m (transform 12ms, setup 0ms, import 19ms, tests 1ms, environment 0ms)[22m
[35m@quorum/templates:test: [0m
[36m@quorum/compiler:test: [0m
...
[32m@quorum/shared:test: [0m [31m❯[39m src/wire.test.ts [2m([22m[2m2 tests[22m[2m | [22m[31m1 failed[39m[2m)[22m[32m 3[2mms[22m[39m
[32m@quorum/shared:test: [0m[31m     [31m×[31m accepts only the two envelope shapes and finite non-negative integer counts[39m[32m 2[2mms[22m[39m
...
[32m@quorum/shared:test: [0m [31m❯[39m src/docs.test.ts [2m([22m[2m59 tests[22m[2m | [22m[31m2 failed[39m[2m)[22m[32m 70[2mms[22m[39m
...
[32m@quorum/shared:test: [0m     [32m✓[39m every entry file is listed once, in the order the folder holds them[32m 3[2mms[22m[39m
...
[32m@quorum/shared:test: [0m     [32m✓[39m the dates never go backwards — the index is append-only, newest last[32m 6[2mms[22m[39m
...
[32m@quorum/shared:test: [0m     [32m✓[39m the plan's narrowed surface still holds the sentence this ticket corrected[32m 7[2mms[22m[39m
...
[32m@quorum/shared:test: [0m     [32m✓[39m both files state the vocabulary rule, and the extractor finds the real list[32m 0[2mms[22m[39m
...
… 183770 characters of output omitted from the middle …

9,
[35m@quorum/server:test: [0m  'not-a-reason': 400,
[35m@quorum/server:test: [0m} as const satisfies Record<StopRefusal, number>;
[35m@quorum/server:test: [0m
[35m@quorum/server:test: [0m/**
[35m@quorum/server:test: [0m * A started run, as the wire reports it.
[35m@quorum/server:test: [0m *
...
[35m@quorum/server:test: [0m[2m   Start at [22m 00:26:07
[35m@quorum/server:test: [0m[2m   Duration [22m 4.48s[2m (transform 2.14s, setup 0ms, import 3.53s, tests 8.56s, environment 1ms)[22m
[35m@quorum/server:test: [0m
[35m@quorum/server:test: [0m[41m[30m ELIFECYCLE [39m[49m [31mTest failed. See above for more details.[39m
[36m@quorum/cli:test: [0m [32m✓[39m src/step-id.test.ts [2m([22m[2m7 tests[22m[2m)[22m[33m 5142[2mms[22m[39m
[36m@quorum/cli:test: [0m [32m✓[39m src/build-fixture.test.ts [2m([22m[2m5 tests[22m[2m)[22m[33m 7125[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m a rebuilt package executes the new source, not the artifact from the old one [33m 2112[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m and a changed build configuration moves the emit too, not only a changed source [33m 1414[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m a removed source entry does not survive as an executable emitted file [33m 1350[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m and the same inputs produce the same paths and the same bytes, emit present or absent [33m 1134[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m turbo prunes no output directory itself, which is why the build script does [33m 1101[2mms[22m[39m
[36m@quorum/cli:test: [0m [32m✓[39m src/run.test.ts [2m([22m[2m42 tests[22m[2m)[22m[33m 6728[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m a passing run answered advance completes and exits 0 [33m 390[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m --gate-answer abort ends the run aborted and exits 2 [33m 340[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m AC-5(1) — the queue is invocation-local, so two runs in one process each get all of it [33m 388[2mms[22m[39m
[36m@quorum/cli:test: [0m [32m✓[39m src/failure-paths.test.ts [2m([22m[2m34 tests[22m[2m)[22m[33m 7625[2mms[22m[39m
[36m@quorum/cli:test: [0m [32m✓[39m src/end-to-end.test.ts [2m([22m[2m43 tests[22m[2m)[22m[33m 8153[2mms[22m[39m
[36m@quorum/cli:test: [0m [32m✓[39m src/board.test.ts [2m([22m[2m40 tests[22m[2m)[22m[33m 8029[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m C3 — an unresolvable branch, an absent branch key and an empty backlog all render as today [33m 341[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m C5 — a shallow clone is indeterminate (shallow clone), with no ahead count [33m 362[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m C10 — `no branch` is reported once the stage claims the work is done, and not before [33m 536[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m AC-6 — the count is upstream..base, and a symmetric difference would read one more [33m 381[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m AC-8 — the legend borrows none of containment's vocabulary [33m 318[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m AC-3 and AC-5 — a base tracking nothing says so, in the repository's own names [33m 344[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m AC-4 — it reads: no ref moves, no file appears, and FETCH_HEAD is untouched [33m 318[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m AC-11 — every outcome still exits 0, including the ones git could not answer [33m 505[2mms[22m[39m
[36m@quorum/cli:test: [0m [32m✓[39m src/build.test.ts [2m([22m[2m65 tests[22m[2m)[22m[33m 36665[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m audited whole in an isolated copy, the build writes its emit and turbo's metadata and nothing else [33m 4208[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m and that audit reports a build that writes into .git, .harness or .quorum, or deletes a file [33m 3045[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m and it reports an artifact hidden beside a turbo log, which the exemption used to swallow [33m 2803[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m the real workspace builds, and its emit and the declaration agree in both directions [33m 2826[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m a cache hit restores an artifact a plain node process can import and use [33m 2925[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m the same chain runs in an isolated copy — tracked files, install, build, execute [33m 2749[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m and it runs when executed directly, which is the difference the mode bit makes [33m 377[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m pnpm links a shim from the root devDependency, and it resolves inside this package [33m 670[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m and `pnpm exec quorum help` — the command AC-18 selected — runs, with nothing to fall back to [33m 761[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m each of the three declares files, and the pack result carries the emit and nothing repository-only [33m 796[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m the packed set installs outside the workspace with the registry dead, and runs [33m 3042[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m pnpm pack and npm pack agree on the file list, for every package in the distribution set [33m 1473[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m and they disagree on the packed manifest, which is why the fixture above packs with pnpm [33m 1004[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m a hit restores the file with its shebang, its mode bit and its behaviour intact [33m 3112[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m a verified login with an ahead state exits 0, and the clause still prints [33m 653[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m a failed login with an as-verified state exits 1, and the agreeing state did not soften it [33m 703[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m and the presence listing exits 0 whatever the state, printing no clause at all [33m 627[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m --probe reports both logins verified and exits 0 [33m 649[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m and the same fixture measuring its answer still reports both numbers, so the omission is the absence [33m 641[2mms[22m[39m
[36m@quorum/cli:test: [0m     [33m[2m✓[22m[39m --json carries the distinction the human line does not [33m 400[2mms[22m[39m
...
[36m@quorum/cli:test: [0m[2m   Start at [22m 00:26:07
[36m@quorum/cli:test: [0m[2m   Duration [22m 37.00s[2m (transform 4.87s, setup 0ms, import 7.29s, tests 90.38s, environment 1ms)[22m
[36m@quorum/cli:test: [0m

[1m Tasks:    [32m[1m3 successful[0m, 7 total[0m
[1mCached:    [1m0 cached[0m, 7 total[0m
[1m  Time:    [1m1m12.448s[0m [0m
