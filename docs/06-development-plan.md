...
- Q-0017 The web app has a backlog board. *(`reviewed` and `main:contained` 2026-09-16 — **M3's
  ...
  *"GO-2 is fully discharged"* — said of two documents while a third was never looked at. The brief is
  ...
  it.
- Q-0127 The ticket page renders a ticket's folder. *(Opened 2026-09-16 at Q-0017's requirements
  gate, which ruled OQ-1 two tickets rather than one; `draft`, body transcribed from that document's
  Appendix A in full.)* `GET /tickets/:id` serves one ticket's folder and `apps/web` renders it as
