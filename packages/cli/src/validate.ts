 ...
 * change on the command's machine-facing surface. Why: ruled, see Q-0091 erratum E-5 — AC-4's
 * *"both commands"* binds `lint` alone, being true of it and never true of this one;
 * `validate.test.ts`'s AC-2 block is what holds the behaviour.
 *
