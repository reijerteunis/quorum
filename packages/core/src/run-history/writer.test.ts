...
describe('AC-9 — a run that started is a run that ended', () => {
  ...
  test('finalise writes whichever of the six terminal statuses it is given', () => {
    const statuses: RunStatus[] = ['completed', 'failed', 'aborted', 'regressed', 'exhausted', 'interrupted'];
