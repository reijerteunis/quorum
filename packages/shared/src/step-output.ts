...
//   2. `checkAgainstSchema` (packages/core/src/adapters/adapters.ts:607) — an agent's structured
...
//   4. `extractJson` (packages/core/src/adapters/adapters.ts:570) — tolerance for how a VENDOR
