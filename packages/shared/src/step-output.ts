...
//   2. `checkAgainstSchema` (packages/core/src/adapters/adapters.ts:606) — an agent's structured
...
//   4. `extractJson` (packages/core/src/adapters/adapters.ts:569) — tolerance for how a VENDOR
