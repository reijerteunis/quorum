...
//   2. `checkAgainstSchema` (packages/core/src/adapters/adapters.ts:612) — an agent's structured
...
//   4. `extractJson` (packages/core/src/adapters/adapters.ts:575) — tolerance for how a VENDOR
