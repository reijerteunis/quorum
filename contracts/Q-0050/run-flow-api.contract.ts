...
import type { Event, Flow, GateAnswerEnvelope, GateQuestionEvent, ProjectConfig, TicketHistoryEntry } from '@quorum/shared';
...
export declare function loadRole(name: string | null | undefined, harnessDir: string): Frontmatter;
