...
- @docs/GLOSSARY.md — use exactly these terms (harness, flow, gate, adapter, ticket, stage, containment, contract, role, backward edge, integrate, cross-vendor rule, panel, chore flow, occurrence, preflight, dry run, BYOS, build task, emitted artifact, push lag, verified version)
